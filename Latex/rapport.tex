...
Le présent chapitre aura une double tâche. La première est d'introduire l'élément fondamental de notre projet, l'algorithme EM. La seconde, plus ardue, est de mettre en lumière 
...
Dans cette concise partie, nous donnons une preuve d'un théorème essentiel. e preuve de la croissance de la log-vraisemblance des observations $X_1,\cdots, X_n$ au fur et à mesure des itérations de l'algorithme EM.

Ce dernier, et unique, théorème est un résultat fondamental, il apporte une réponse à la raison d'être de l'algorithme, une justification à son élaboration. \\
...
\end{center}
qui ont la particularité de faire croître la log-vraisemblance des observations. Enonçons le et démontrons le. 
