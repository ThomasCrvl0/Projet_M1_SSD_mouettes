...
Les boites à moustaches (boxplot) ci-dessous, modélisent l'erreur absolue entre les paramètres $\mu$ et $\sigma$ estimés par l'algorithme Em et les paramètres $\mu$ et $\sigma$ théoriques.
...
\end{figure}
 ...
 En observant les boxplots, on remarque que plus la taille de l'échantillon n est grande et plus la longueur des boxplots ainsi que leurs médianes diminuent. En d'autre terme, cela indique que l'erreur absolue entre les paramètres estimés par l'algorithme Em et ceux théoriques diminue. On en déduit que dans le cas d'un mélange gaussien "à forte séparation", l'augmentation de la taille de n a pour effet d'améliorer la précision de l'algorithme EM.
